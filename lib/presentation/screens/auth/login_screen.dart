...
class _LoginScreenState extends ConsumerState<LoginScreen>
  ...
  static const _primaryBlue = AuthGlassTheme.primaryBlue;
              ...
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                        color: AuthGlassTheme.inkSecondary.withValues(alpha: 0.86),
                      ),
                ),
                          ...
                          _GlassInputField(
                            ...
                            trailing: IconButton(
                              ...
                              icon: Icon(
                                ...
                                size: 20,
                                color: AuthGlassTheme.inkIcon.withValues(alpha: 0.86),
                              ),
                            ),
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: AuthGlassTheme.panelTint.withValues(alpha: 0.15),
            borderRadius: BorderRadius.circular(22),
            border: Border.all(
  ...
  Widget build(BuildContext context) {
    final gradient = filled
        ? const LinearGradient(
            ...
            colors: [AuthGlassTheme.accentCyan, AuthGlassTheme.primaryBlue],
          )
        : LinearGradient(
            begin: Alignment.topLeft,
            end: Alignment.bottomRight,
            colors: [
              ...
              AuthGlassTheme.panelTint.withValues(alpha: 0.16),
            ],
          );
              ...
              child: Center(
                child: DefaultTextStyle(
                  style: TextStyle(
                    color: filled
                        ? Colors.white
                        : AuthGlassTheme.inkPrimary.withValues(alpha: 0.96),
      ...
      children: [
        Text(
          ...
          style: Theme.of(context).textTheme.labelMedium?.copyWith(
                color: AuthGlassTheme.inkSecondary.withValues(alpha: 0.9),
                fontWeight: FontWeight.w600,
              ),
        ),
        const SizedBox(height: 8),
        ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child: Container(
              decoration: BoxDecoration(
                color: AuthGlassTheme.panelTint.withValues(alpha: 0.17),
                borderRadius: BorderRadius.circular(16),
                border: Border.all(
                  color: AuthGlassTheme.panelTint.withValues(alpha: 0.3),
                ),
              ),
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: hint,
                  hintStyle: const TextStyle(color: Color(0x886184A8)),
                  ...
                  prefixIcon: Icon(
                    leading,
                    color: AuthGlassTheme.inkIcon.withValues(alpha: 0.82),
                    size: 20,
                  ),
                  suffixIcon: trailing,
                ),
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            text,
            style: TextStyle(
              color: AuthGlassTheme.inkSecondary.withValues(alpha: 0.7),
              fontSize: 12,
              fontWeight: FontWeight.w600,
              letterSpacing: 0.6,
            ),
